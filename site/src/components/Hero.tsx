...
import { agentPrompt, assetPaths, type ReleaseInfo } from '../data/siteContent';
  ...
  return (
    <section className="hero" aria-labelledby="hero-title">
      <div className="hero-copy">
        ...
        <p className="lead-line">InvoiceGen for macOS.</p>
      ...
      <figure className="hero-window" aria-label="InvoiceGen product preview">
        <img
